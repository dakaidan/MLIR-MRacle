...
// Restrict the memory order of a randomly chosen atomic op by exactly one
// stage. Only ops that can actually be strengthened are candidates: an op
// already at the strongest order (seq_cst) has no successor and is skipped.
