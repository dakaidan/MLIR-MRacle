// test_25: 3-thread y/z/x chain with guarded x store (made atomic)
// forall (x == 0 /\ y == 1 /\ z == 0)
module {
  func.func @main() -> (i64, i64, i64) {
    ...
    omp.parallel {
      omp.sections {
        omp.section {
          ...
          omp.atomic.read %r0_mem = %z memory_order(acquire) : memref<1xi64>, memref<1xi64>, i64
        ...
        omp.section {
          ...
          %cond_r0_1 = arith.cmpi eq, %r0, %c1_i64 : i64
          scf.if %cond_r0_1 {
            %r2_mem = memref.alloca() : memref<1xi64>
            memref.store %c0_i64, %r2_mem[%c0] : memref<1xi64>
            omp.atomic.read %r2_mem = %x memory_order(relaxed) : memref<1xi64>, memref<1xi64>, i64
            %r2 = memref.load %r2_mem[%c0] : memref<1xi64>
            %cond_r2_1 = arith.cmpi eq, %r2, %c1_i64 : i64
            scf.if %cond_r2_1 {
    ...
    return %x_val, %y_val, %z_val : i64, i64, i64
  }
}
