// test_20: relaxed/acquire y loads guard a non-atomic x store (made atomic)
// forall (x == 0 /\ y == 1)
module {
    ...
    omp.parallel {
      omp.sections {
        omp.section {
          ...
          scf.if %cond_r1_1 {
            %cond_r0_2 = arith.cmpi eq, %r0, %c2_i64 : i64
            scf.if %cond_r0_2 {
              %r2_mem = memref.alloca() : memref<1xi64>
              memref.store %c0_i64, %r2_mem[%c0] : memref<1xi64>
              omp.atomic.read %r2_mem = %y memory_order(relaxed) : memref<1xi64>, memref<1xi64>, i64
              %r2 = memref.load %r2_mem[%c0] : memref<1xi64>
              %cond_r2_2 = arith.cmpi eq, %r2, %c2_i64 : i64
              scf.if %cond_r2_2 {
        ...
        omp.section {
          ...
          scf.if %cond_r0_1 {
            omp.atomic.write %y = %c2_i64 memory_order(relaxed) : memref<1xi64>, i64
          }
          omp.terminator
        }
        omp.terminator
