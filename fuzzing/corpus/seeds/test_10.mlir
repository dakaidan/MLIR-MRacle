// test_10: acquire load ordering
// forall ((0:r0 == 0 /\ 0:r1 == 0 /\ x == 1 /\ y == 1) \/
...
module {
  func.func @main() -> (i64, i64, i64, i64) {
    ...
    %p0_r1_mem = memref.alloc() : memref<1xi64>

    omp.parallel {
      omp.sections {
        omp.section {
          // P0: int r1 = 0; int r0 = 0;
          //     r0 = atomic_load(y, acquire);
          //     r1 = atomic_load(x, relaxed);
          memref.store %c0_i64, %p0_r1_mem[%c0] : memref<1xi64>
          ...
          memref.store %r1, %p0_r1_mem[%c0] : memref<1xi64>
          omp.terminator
        }
        omp.section {
          // P1: atomic_store(x, 1, relaxed);
          //     atomic_store(y, 1, release);
    ...
    %p0_r1 = memref.load %p0_r1_mem[%c0] : memref<1xi64>
    ...
    memref.dealloc %p0_r1_mem : memref<1xi64>
    return %p0_r0, %p0_r1, %x_val, %y_val : i64, i64, i64, i64
  }
}
