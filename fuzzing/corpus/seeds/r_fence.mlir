// R+fencembonceonces: full fences, y overwritten by P1
// P0: atomic_write(x, 1); omp.flush; atomic_write(y, 1)
// P1: atomic_write(y, 2); omp.flush; r0 = read(x)
// bad outcome (y=2 /\ 1:r0=0)
module {
